...
"""
                    keyboard = [
                        [InlineKeyboardButton("💎 Join VIP", url=f"https://t.me/AutoAdvPaymentBot?start=buy_vip")],
        ...
        if update.effective_chat.type != "private":
            await update.message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([[
                    InlineKeyboardButton("🔒 Start Secure Chat", url=f"https://t.me/AutoAdvPaymentBot?start=secure")
                ]]),
                parse_mode=ParseMode.MARKDOWN
            )
            return
...
💰 *PRODUCT PRICES:*
• Advertisement: $10 USDT (30 days)
• VIP Membership: $50 USDT (60 days)  
• Scammer Report: $5 USDT (Permanent)
...
"""
    ...
    async def process_advertisement_purchase(self, user_id: int, update: Update):
        ...
        await update.message.reply_text(
            ...
            "✅ Runs for 30 days\n\n"
            "📊 Monitor with: /adviewqueue (in DM)\n"
