...
"""
    ...
    # Purchase conversation handlers - MODIFIED FOR PAYMENT MODE
    ...
    async def confirm_purchase(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """Confirm and process purchase - MODIFIED for payment mode"""
        query = update.callback_query
        await query.answer()
        ...
        # MODIFIED: Different messages based on payment mode
        if self.payment_mode == "dummy":
            await query.edit_message_text(
                f"{message}"
            ...
            await query.edit_message_text(
                ...
                f"💰 *Amount:* $50.00\n"
                f"⏰ *Duration:* 7 days\n"
                f"🔄 *Starts:* After payment confirmation\n\n"
