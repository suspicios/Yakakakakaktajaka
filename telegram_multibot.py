        ...
        for admin_id in ADMIN_IDS:
            try:
                await self.app.bot.send_message(
                    chat_id=admin_id,
                    text=(
                        "🚨 *NEW SCAMMER REPORT PENDING APPROVAL* 🚨\n\n"
                        f"👤 *Reporter:* @{update.effective_user.username}\n"
                        f"📝 *Details:* {data['scammer_details'][:100]}...\n"
                        f"💰 *USDT Address:* `{data.get('scammer_usdt_address', 'Not provided')}`\n\n"
                        "Please review and approve/deny this report."
                    ),
                    parse_mode=ParseMode.MARKDOWN
                )
            except Exception as e:
...
🚨 *Your report has been received and is pending admin review!*

📋 *What happens next:*
• Admin reviews your report
• Evidence verification  
• If approved, posted to scammer channel
• Community alerted
