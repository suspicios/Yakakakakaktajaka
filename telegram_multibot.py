...
Author: Claude  
Version: 1.2.5 - All Issues Fixed + Enhanced Stability
"""
...
"""
    ...
    async def handle_ad_flow(self, update: Update, context: ContextTypes.DEFAULT_TYPE, state: Dict, message: str):
        ...
        if state['step'] == 1:  # Heading
            ...
            await update.message.reply_text(
                "✅ *Description saved!*\n\n"
                "━━━━━━━━━━━━━━━━\n"
                "📝 *Step 4 of 7: Enter Contact Details*\n\n"
        ...
        elif state['step'] == 5:  # Buttons (handled by callback)
            pass  # This step is handled by callback
        
        elif state['step'] == 6:  # Image
            keyboard = [
        ...
        elif state['step'] == 7:  # Image URL (if yes)
    ...
    async def handle_payment_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if data == "buttons_yes":
            ...
            state['step'] = 6
            await self.handle_ad_flow(query, context, state, "")
            ...
            async with db_manager.get_connection() as db:
                await db.execute("""
                    ...
                    (user_id, username, heading, type, description, contact, created_at, expires_at, 
                     has_buttons, has_image, image_url)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """, (
                    user_id,
                    username,
...
🚨 *SUPPORT:*
For issues with payments or activation, contact:
• @SupportUsername (replace with actual)
