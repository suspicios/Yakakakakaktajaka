...
Author: Claude  
Version: 1.4.0 - AutoADV Flow Fixed + Admin Free Ads + Enhanced Scammer Reports
"""
...
# ============================
# 🤖 1. ADVERTISING BOT - COMPLETE WITH ALL FEATURES (FIXED)
# ============================
...
class AdvertisingBot:
    def __init__(self, token: str):
        ...
        self.updater = None  # Add updater attribute
...
"""
    ...
    async def start_scammer_report(self, query, context, user_id):
        ...
        await query.edit_message_text(
            ...
            "━━━━━━━━━━━━━━━━\n"
            "📝 *Step 1 of 5: Enter Scammer Details*\n\n"
    ...
    async def handle_scammer_flow(self, update: Update, context: ContextTypes.DEFAULT_TYPE, state: Dict, message: str):
        ...
        if state['step'] == 1:  # Scammer details
            ...
            await update.message.reply_text(
                "✅ *Evidence saved!*\n\n"
                "━━━━━━━━━━━━━━━━\n"
                "📝 *Step 3 of 5: Enter Your Contact*\n\n"
            ...
            await update.message.reply_text(
                "✅ *Contact saved!*\n\n"
                "━━━━━━━━━━━━━━━━\n"
                "📝 *Step 4 of 5: Communication Screenshot*\n\n"
            ...
            await update.message.reply_text(
                "✅ *Screenshot received!*\n\n"
                "━━━━━━━━━━━━━━━━\n"
                "📝 *Step 5 of 5: Scammer USDT Address*\n\n"
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.info("🔧 Version: 1.4.0 - AutoADV Bot Flow Fixed + Admin Free Ads + Enhanced Scammer Reports")
